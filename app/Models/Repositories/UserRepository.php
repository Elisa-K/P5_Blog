...
class UserRepository
{
    ...
    {
        $stmt = $this->dbConnect->prepare("SELECT id, username, firstname, lastname, email, DATE_FORMAT(createdAt, '%d/%m/%Y à %Hh%i') as french_createdAt, isAdmin FROM user WHERE id != :id ORDER BY isAdmin DESC");
